...
class Campaign_User(val username: String, val id: Int, val email: String, val provider: String,
                        val confirmed: Boolean, val blocked: Boolean, val role: Int, val prenom: String,
